...
const Demo = () => {
  ...
  const numberOfDays = parseInt(localStorage.getItem('number_Of_Days'));
  const [remainingSubmissions, setRemainingSubmissions] = useState(numberOfDays);
  ...
  const handleabouthotelChange = (e) => {
  ...
  const handleSubmit = (e) => {
    ...
    postData.append('abouthotel', abouthotel);
    postData.append('thingstodo', thingstodo);
    ...
    axios
      ...
      .then((response) => {
        ...
        setRemainingSubmissions((prevSubmissions) => prevSubmissions - 1);
      })
      .catch((error) => {
          ...
          <div className="details personal">
            ...
            <div className="fields">
              ...
              <div className="input-field">
                ...
                <input type="text" placeholder="Enter about hotel" 
               value={abouthotel}
               onChange={handleabouthotelChange} 
               required />
              </div>

              <div className="input-field">
                <label>things to do</label>
                <input type="text" placeholder="Enter thingstodo" 
               value={thingstodo}
          ...
          <div className="details ID">
            ...
            <span className="btnText">
                {remainingSubmissions > 0
                  ? `Submit ${remainingSubmissions} more times`
