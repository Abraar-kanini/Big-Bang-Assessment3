...
export default function AgentPost() {
    ...
    const adminid = localStorage.getItem('adminpost');
    ...
    const handleSubmit = (e) => {
        ...
        postData.append('agentRegister.agent_Id', agentid);
        postData.append('adminPost.id', adminid);
        ...
        axios
          ...
          .then((response) => {
            ...
            localStorage.setItem('number_Of_Days', formData.number_Of_Days);

            console.log('Data successfully posted:', response.data);
            navigate('/numberofdaysforpackage');
          })
          .catch((error) => {
